    ...
    >
      ...
      <div className="absolute inset-0">
        <ParallaxElement speed={0.2} className="absolute top-20 left-10">
          <div className="w-20 h-20 bg-gradient-to-r from-violet to-violet-dark rounded-full opacity-20 animate-float floating-element" style={{ '--delay': '0s' } as React.CSSProperties}></div>
        </ParallaxElement>
        <ParallaxElement speed={0.3} className="absolute top-40 right-20">
          <div className="w-16 h-16 bg-gradient-to-r from-secondary to-lavender rounded-full opacity-30 animate-float floating-element" style={{ '--delay': '2s' } as React.CSSProperties}></div>
        </ParallaxElement>
        <ParallaxElement speed={0.15} className="absolute bottom-40 left-20">
          <div className="w-12 h-12 bg-gradient-to-r from-violet-dark to-violet rounded-full opacity-25 animate-float floating-element" style={{ '--delay': '4s' } as React.CSSProperties}></div>
        </ParallaxElement>
        ...
        <ParallaxElement speed={0.35} className="absolute bottom-1/3 left-1/4">
          <div className="w-10 h-10 bg-gradient-to-r from-secondary/20 to-violet/20 rounded-full blur-sm animate-float" style={{ '--delay': '3s' } as React.CSSProperties}></div>
        </ParallaxElement>
      </div>
      ...
      <div className="absolute inset-0">
        ...
        >
          <source src="https://res.cloudinary.com/dxam3lhff/video/upload/v1768927243/bgvideo_l4impg.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 container mx-auto px-4 pt-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <ParallaxText delay={0.2}>
            <h1 className="font-display font-black uppercase text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-primary-foreground tracking-wider mb-8 stagger-animation" style={{ '--delay': '0.2s' } as React.CSSProperties}>
              ...
              <span className="block gradient-text animate-text-glow relative">
                POTENTIAL
                <ParallaxElement speed={0.5} className="absolute -top-4 -right-4">
                  <div className="animate-bounce-in" style={{ '--delay': '1s' } as React.CSSProperties}>
          ...
          {/* Enhanced Subtitle with Parallax */}
          <ParallaxText delay={0.3}>
          ...
          {/* Enhanced Stats Grid with Parallax */}
          <ParallaxText delay={0.5}>
      ...
      <ParallaxElement speed={0.1} className="absolute bottom-8 left-1/2 -translate-x-1/2">
        <div className="animate-bounce-in" style={{ '--delay': '1.2s' } as React.CSSProperties}>
          <button
      ...
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(20)].map((_, i) => (
          ...
          >
            <div
              className="w-1 h-1 bg-secondary rounded-full opacity-30 animate-float"
              style={{
